      ...
      <div class="bar">
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url()?>jurnal">Edit Jurnal</a></li>
          </ol>
        </section>
      </div>
    </head>
    <section class="content">
       ...
       <form class="form-horizontal" action="<?php echo base_url('jurnal/submit_jurnal')?>" method="post">
          <div class="form-group">
            ...
            <div class="col-md-9">
              <input class="form-control" name="judul" value="<?php echo $jurnal->judul; ?>" placeholder="Judul" type="text" required/>
          ...
          <div class="form-group">
            ...
            <div class="col-md-9">
              <input class="form-control" name="nomorjurnal" value="<?php echo $jurnal->no_jurnal; ?>" placeholder="Nomor Jurnal" type="text" required/>
          ...
          <div class="form-group">
            ...
            <div class="col-md-9">
              <input class="form-control" name="urlportal" value="<?=$jurnal->url?>" placeholder="URL" type="text" required/>
          ...
          <div class="form-group">
            ...
            <div class="col-md-9">
              ...
              <select class="form-control select2" name="id_penerbit" id="auto-penerbit">
                <option value="<?=$jurnal->id_jenis?>"><?=$penerbit?></option>
              </select>
          ...
          <div class="form-group">
            ...
            <div class="col-md-9">
              <input class="form-control" name="sponsor" value="<?php echo $jurnal->sponsor; ?>" placeholder="sponsor" type="text" />
          ...
          <div class="form-group">
            ...
            <div class="col-md-9">
              <input class="form-control" name="singkatan" value="<?php echo $jurnal->singkatan; ?>" placeholder="Singkatan" type="text" required/>
          ...
          <div class="form-group">
            ...
            <div class="col-md-9">
              <input class="form-control" name="pissn" value="<?php echo $jurnal->p_issn; ?>" placeholder="p-issn" type="text" />
          ...
          <div class="form-group">
            ...
            <div class="col-md-9">
              <input class="form-control" name="eissn" value="<?php echo $jurnal->e_issn; ?>" placeholder="e-issn" type="text" />
          ...
          <div class="form-group">
            ...
            <div class="col-md-9">
              <input class="form-control" name="doi" value="<?php echo $jurnal->doi; ?>" placeholder="DOI" type="text" required/>
          ...
          <div class="form-group">
            ...
            <div class="col-md-9">
              <input class="form-control" name="thnmulai" value="<?php echo $jurnal->thn_mulai; ?>" placeholder="Tahun Mulai" type="text" required/>
          ...
          <div class="form-group">
            ...
            <div class="col-md-9">
              <input class="form-control" name="terbitakhir" value="<?php echo $jurnal->terbit_terakhir; ?>" placeholder="Terbit Terakhir" type="text" required/>
          ...
          <div class="form-group">
            ...
            <div class="col-md-9">
              <input class="form-control" name="noterakhir" value="<?php echo $jurnal->no_terakhir; ?>" placeholder="Jumlah No.Terakhir" type="text" required/>
          ...
          <div class="form-group">
            ...
            <div class="col-md-9">
              <input class="form-control" name="urlsinta" value="<?php echo $jurnal->url_sinta; ?>" placeholder="Url Sinta" type="text" required/>
