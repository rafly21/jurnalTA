...
(3, 5, 'BONI', 'besudigdo@gmail.com', 87731437, 'b.jpg'),
...
CREATE TABLE `jurnal` (
  ...
  `bln_terbit1` int(2) NOT NULL,
  `bln_terbit2` int(2) NOT NULL,
  `bln_terbit3` int(2) NOT NULL,
  `bln_terbit4` int(2) NOT NULL,
  `doi` varchar(10) NOT NULL,
  `mpgundip` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `jurnal` (`id_jurnal`, `no_jurnal`, `id_pengelola`, `judul`, `id_penerbit`, `singkatan`, `sponsor`, `e_issn`, `p_issn`, `english`, `thn_mulai`, `no_terakhir`, `terbit_terakhir`, `frekuensi`, `bln_terbit1`, `bln_terbit2`, `bln_terbit3`, `bln_terbit4`, `doi`, `mpgundip`) VALUES
(1, 85, 3, 'Jurnal Anestesiologi Indonesia', 2, 'Janesti', 'Perhimpunan Dokter Spesialis Anestesiologi dan Terapi Intensif (PERDATIN)', '2089-970X', '2337-5124', 'tidak', '2012', '1', 2016, 3, 3, 6, 11, 0, '10.14710', 'tidak'),
(2, 4, 8, 'ILMU KELAUTAN: Indonesian Journal of Marine Sciences', 3, 'IJMS', 'Association of Indonesian Coastal Management Experts (HAPPI)', '2406-7598', '0853-7291', 'ya', '2012', '4', 2017, 4, 3, 6, 9, 12, '10.14710', 'ya'),
(3, 80, 12, 'International Journal of Renewable Energy Development', 4, 'IJRED', '', '2252-4940', '', 'ya', '2012', '3', 2017, 3, 2, 7, 10, 0, '10.14710', 'ya');
...
INSERT INTO `portal` (`nama_portal`, `id_portal`) VALUES
('ejournal1', 1),
('ejournal2', 2),
('ejournal3', 3);
...
--
ALTER TABLE `data_pengelola`
  MODIFY `id_pengelola` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `departemen`
--
ALTER TABLE `departemen`
  MODIFY `id_dept` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=119;
...
--
ALTER TABLE `jurnal`
  MODIFY `id_jurnal` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `lembaga`
  MODIFY `id_lembaga` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;
...
--
ALTER TABLE `pengindeks`
  MODIFY `id_pengindeks` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `portal`
--
ALTER TABLE `portal`
  MODIFY `id_portal` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
